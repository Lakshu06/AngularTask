...
export class AppComponent {
	...
	tableObj: Object = {
		headers: [
			{'key': 'name', 'search': true, 'sort': false },
			{'key': 'mail', 'search': true, 'sort': true },
			{'key': 'contact2', 'search': true, 'sort': false },
			{'key': 'address', 'search': true, 'sort': true },
			{'key': 'post', 'search': false, 'sort': false },
			{'key': 'experience', 'sort': true },
			{'key': 'id', 'search': false, 'sort': true },
			{'key': 'technology', 'search': false, 'sort': false },
			{'key': 'companyname', 'search': true, 'sort': true }
		],
		data: [
